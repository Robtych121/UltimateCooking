...
def add_recipe():
    return render_template("recipe/recipe_add.html",
...
def insert_recipe():
    ...
    upload_file(app.config['UPLOAD_FOLDER_RECIPE'] + "/" + f.filename,
...
def manage_recipes():
    return render_template("recipe/recipe_manage.html",
...
def edit_recipe(recipe_id):
    ...
    return render_template("recipe/recipe_edit.html",
                           recipe=the_recipe,
                           cuisines=mongo.db.cuisines.find(),
                           ingredients=mongo.db.ingredients.find(),
                           tools=mongo.db.tools.find(),
                           instructions=the_recipe['instructions'],
...
def edit_recipe_picture(recipe_id):
    the_recipe = mongo.db.recipes.find_one({'_id': ObjectId(recipe_id)})
    return render_template("recipe/recipe_pic_edit.html",
                           recipe=the_recipe,
                           imagePath=app.config['UPLOAD_FOLDER_RECIPE'],
...
def view_recipes_grid():
    return render_template("recipe/recipe_view_grid.html",
                           recipes=mongo.db.recipes.find(),
                           imagePath=app.config['UPLOAD_FOLDER_RECIPE'],
                           cuisines=mongo.db.cuisines.find(),
                           ingredients=mongo.db.ingredients.find(),
